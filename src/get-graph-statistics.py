...
def main(dataset_name, print_subnets, filter_th=0.7):
    ...
    if print_subnets:
        for trace_name in ['coRT', 'coURL', 'hashSeq', 'tweetSim']:
...
if __name__ == "__main__":
    ...
    parser.add_argument('-print_subnets', '--subnets', type=bool,
                        help='printing info of several subnets from different behavioral traces',
                        default=False)
    args = parser.parse_args()
    main(args.dataset, args.subnets)
