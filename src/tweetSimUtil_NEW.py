...
def textSim(control, treated, outputDir, stopword, cudaId='1', maxRows=1000):
    ...
    while date <= finalDate:
        ...
        if len(combined_tweets_df.index) > maxRows:
            combined_tweets_df = combined_tweets_df.sample(maxRows, random_state=42)
